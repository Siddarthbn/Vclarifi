...
try:
    ...
    DB_HOST, DB_DATABASE, DB_USER, DB_PASSWORD = None, None, None, None
    SENDER_EMAIL, SENDER_APP_PASSWORD, SMTP_SERVER, SMTP_PORT = None, None, None, None
